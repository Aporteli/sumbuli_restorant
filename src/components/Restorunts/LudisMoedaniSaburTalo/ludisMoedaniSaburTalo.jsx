...
import styles from "./ludisMoedaniSaburTalo.module.css";
import modalStyles from "./ludisMoedaniSaburTalo.module.css";
import { useEffect, useState } from "react";
import MainComponent from "../MainComponent";
import { FaCaretLeft, FaCaretRight, FaTimes } from "react-icons/fa";

import MainImage from "./ludisSaburtasoImages/MainImage.webp";
import featuredImage from "./ludisSaburtasoImages/featuredImage.webp";
import TextForMiddlePage from "./textForMiddlePage";

import Img1 from "./ludisSaburtasoImages/Img 1.webp";
import Img2 from "./ludisSaburtasoImages/Img 2.webp";
import Img3 from "./ludisSaburtasoImages/Img 3.webp";
import Img4 from "./ludisSaburtasoImages/Img 4.webp";
...
const getIndexAndLength = (currentImage) => {
  ...
  if (currentImage.id >= 1 && currentImage.id <= 9) {
    targetArray = [...FIRST_SLIDER];
  }
...
function LudisMoedaniSaburTalo() {
...
export default LudisMoedaniSaburTalo;
