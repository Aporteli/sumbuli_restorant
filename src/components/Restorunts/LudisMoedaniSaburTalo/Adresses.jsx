  ...
  return (
    <div className={styles.divForAdresses}>
      <div className={styles.addressSection}>
        ...
        <a href="ddd" className={styles.a_sanadimo_adr_1}>
          Tbilisi, A. Gudavadze Street N99/67/094
        </a>
      </div>
      ...
      <div className={styles.emailSection}>
        ...
        <a href="ddd" className={styles.a_sanadimo_adr_1}>
          fictional@email.com / fictional@email.com
        </a>
      </div>
      <div className={styles.workingHoursSection}>
        <div className={styles.title}>Working hours</div>
        <a href="ddd" className={styles.a_sanadimo_adr_1}>
          Restaurant working hours: 16:00 - 01:00, evening hours: 16:00 - 23:00
        </a>
      </div>
