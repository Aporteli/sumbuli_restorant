...
import styles from "./LudisMoedani.module.css";
import modalStyles from "./LudisMoedani.module.css";
import { useEffect, useState } from "react";
import MainComponent from "../MainComponent";
import { FaCaretLeft, FaCaretRight, FaTimes } from "react-icons/fa";

import featuredImage from "./ludisMoedaniImages/featuredImage.webp";
import MainImage from "./ludisMoedaniImages/MainImage.webp";
import TextForMiddlePage from "./textForMiddlePage";
import Adresses from "./Adresses";

import Img1 from "./ludisMoedaniImages/Img-1.webp";
import Img2 from "./ludisMoedaniImages/Img-2.webp";
import Img3 from "./ludisMoedaniImages/Img-3.webp";
import Img4 from "./ludisMoedaniImages/Img-4.webp";

import Img10 from "../1Images/img-2.webp";
import Img11 from "../1Images/img-3.webp";
import Img12 from "../1Images/img-4.webp";
import Img13 from "../1Images/img-5.webp";
import Img14 from "../1Images/img-6.webp";
import Img15 from "../1Images/img-7.webp";
import Img16 from "../1Images/img-8.webp";
import Img17 from "../1Images/img-9.webp";
import Img18 from "../1Images/img-10.webp";
...
const IMAGES_RESTORANT = [
  { url: Img17, alt: "Img two", id: 8 },
  { url: Img10, alt: "Img four", id: 1 },
  { url: Img11, alt: "Img five", id: 2 },
  { url: Img12, alt: "Img six", id: 3 },
  { url: Img13, alt: "Img one", id: 4 },
  { url: Img14, alt: "Img two", id: 5 },
  { url: Img15, alt: "Img two", id: 6 },
  { url: Img16, alt: "Img two", id: 7 },
  { url: Img18, alt: "Img two", id: 9 },
];
...
const getIndexAndLength = (currentImage) => {
  ...
  if (currentImage.id >= 10 && currentImage.id <= 18) {
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.restoruntSection}>
        <h1 className={styles.chveni_obieqtebi}>ჩვენი ობიექტები</h1>
