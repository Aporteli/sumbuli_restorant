...
import styles from "./WisqviliWknetshi.module.css";
import modalStyles from "./WisqviliWknetshi.module.css";
import { useEffect, useState } from "react";
import MainComponent from "../MainComponent";
import { FaCaretLeft, FaCaretRight, FaTimes } from "react-icons/fa";

import MainImage from "./wknetiImages/MainImage.webp";
import featuredImage from "./wknetiImages/featuredImage.webp";
import TextForMiddlePage from "./textForMiddlePage";
import Adresses from "./Adresses";
import Sivrceebi from "./Sivrceebi/Sivrceebi";

import Img1 from "./wknetiImages/Img 1.webp";
import Img2 from "./wknetiImages/Img 2.webp";
import Img3 from "./wknetiImages/Img 3.webp";
import Img4 from "./wknetiImages/Img 4.webp";

import Img8 from "./wknetiImages/Img 8.webp";
...
const SIVRCEEBI_SLIDER = [{ url: Img8, alt: "Img six", id: 8 }];
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.restoruntSection}>
        <h1 className={styles.chveni_obieqtebi}>Our Properties</h1>
...
export default WisqviliWknetshi;
