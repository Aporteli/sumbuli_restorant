...
import styles from "./WisqviliMcxetashi.module.css";
import modalStyles from "./WisqviliMcxetashi.module.css";
import { useEffect, useState } from "react";
import MainComponent from "../MainComponent";
import { FaCaretLeft, FaCaretRight, FaTimes } from "react-icons/fa";

import MainImage from "./mcxetaImages/featuredImage.webp";
import featuredImage from "./mcxetaImages/featuredImage.webp";
import TextForMiddlePage from "./textForMiddlePage";
import Adresses from "./Adresses";
import Sivrceebi from "./Sivrceebi/Sivrceebi";

import Img1 from "./mcxetaImages/Img 1.webp";
import Img2 from "./mcxetaImages/Img 2.webp";
import Img3 from "./mcxetaImages/Img 3.webp";
import Img4 from "./mcxetaImages/Img 4.webp";

import Img10 from "./mcxetaImages/Img 10.webp";

import Img11 from "./mcxetaImages/Img 11.webp";
...
const SIVRCEEBI_SLIDER = [{ url: Img10, alt: "Img two", id: 10 }];

const MUSIC_PROGGRAM = [{ url: Img11, alt: "Img four", id: 11 }];
...
function WisqviliMcxetashi() {
  ...
  // Body scroll control when modal opens/closes
  useEffect(() => {
    if (isModalOpen) {
  ...
  // Navigation in modal: next and previous image
  const nextImage = () => {
  ...
  // Current information on active array
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.middleDiv}>
        ...
        <div className={styles.outerDivForAdresses}>
          <div className={styles.adressesOuter}>
            ...
            <p className={styles.mcxeta_main_p_1}>20:00-22:00</p>
            <p className={styles.mcxeta_main_p_1}>
              Every day except Monday and Tuesday: duet "Jane and Mary"
            </p>
            <Adresses />
          </div>
        </div>
      ...
      {/* Musical program (slider) */}
      <div className={styles.sliderMusic}>
        <h1 className={styles.sectionTitle}>Musical Program</h1>
...
export default WisqviliMcxetashi;
