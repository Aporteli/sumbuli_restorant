  ...
  return (
    <div className={styles.divForAdresses}>
      <div className={styles.addressSection}>
        <div className={styles.title}>მისამართი</div>
        <a href="ddd" className={styles.a_tetri_adr_1}>
          თბილისი, ა. ბელიაშვილის #99
        </a>
      </div>
      <div className={styles.phoneSection}>
        <div className={styles.title}>ტელეფონი</div>
        <a href="ddd" className={styles.a_tetri_adr_1}>
          +995 577 00 08 88
        </a>
      </div>
      <div className={styles.emailSection}>
        <div className={styles.title}>ელ.ფოსტა</div>
        <a href="ddd" className={styles.a_tetri_adr_1}>
          info@teatri.ge
        </a>
      </div>
      <div className={styles.workingHoursSection}>
        <div className={styles.title}>სამუშაო საათები</div>
        <a href="ddd" className={styles.a_tetri_adr_1}>
          19:00-01:30
        </a>
      </div>
